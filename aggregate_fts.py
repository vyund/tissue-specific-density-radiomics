...
if __name__ == '__main__':
    dense_ft_path = './extracted_fts/extracted_fts_dense.csv'
    adipose_ft_path = './extracted_fts/extracted_fts_adipose.csv'
    ...
    discrete_tissue.to_csv('./extracted_fts/extracted_fts_discrete.csv')
